...
export const resetPassword = async ({ password, authorization }: ResetPasswordRequest) =>
  await axios.patch(`${process.env.REACT_APP_API_URL}/auth/reset-password`, { password }, {  headers: { authorization } })
