...
export const RegisterForm = () => {
  ...
  return (
    <Grid container component="main" sx={{ height: "77%", display: "flex", justifyContent: "center", alignItems: "center" }}>
      <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square sx={{ borderRadius: "20px", height: "80%", padding: "1em" }}>
